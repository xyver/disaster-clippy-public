...
Disaster Clippy supports multiple deployment scenarios to fit different use cases and infrastructure setups. Each scenario can be configured with personal cloud storage for backups.
...
**Configure Personal Cloud Backup:**

1. Navigate to http://yourdomain.com:8000/useradmin/settings
2. Scroll to "Personal Cloud Backup" section
3. Enable personal cloud backup
4. Select your cloud provider (Cloudflare R2, AWS S3, Backblaze B2, etc.)
5. Enter your credentials:
   ...
   - For **Backblaze B2**:
     ...
     - Access Key ID: From B2 dashboard
     - Secret Access Key: From B2 dashboard
     - Bucket Name: Your bucket name
     - Region: `us-west-002` (or your region)
...
**Security:**
- `.env` contains official R2 bucket credentials (global admin)
- `local_settings.json` contains personal cloud credentials (testing)
- Both files are gitignored, never committed
- Credentials are masked in settings UI
